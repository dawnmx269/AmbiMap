...
function WayResults() {
  ...
  const handleNext = () => {
    ...
    // 현재 카테고리의 최종 결과를 저장
    const categoryFinalResult = selectedChars.join('') + '향';  
    setCategoryResult('way', categoryFinalResult);
  ...
  return (
    <div style={{ 
      ...
      <h1 style={{ marginBottom: '30px' }}>진로에서 느끼는 애매한 감정</h1>
      ...
      {selectedChars.length === 2 && (
        <div style={{
          ...
          <span style={{ color: '#2E7D32' }}>향</span>
        </div>
      )}
