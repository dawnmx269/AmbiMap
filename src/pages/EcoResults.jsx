...
function EcoResults() {
  ...
  const handleNext = () => {
    ...
    // 현재 카테고리의 최종 결과를 저장
    const categoryFinalResult = selectedChars.join('') + '립';
    setCategoryResult('economy', categoryFinalResult); 
  ...
  return (
    <div style={{ 
      ...
      <h1 style={{ marginBottom: '30px' }}>경제적 독립에서 느끼는 감정</h1>
      ...
      {selectedChars.length === 2 && (
        <div style={{
          ...
          <span style={{ color: '#2E7D32' }}>립</span>
        </div>
      )}
